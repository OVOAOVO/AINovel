...
public class Aff_Tx_3 : MonoBehaviour
{
    [SerializeField] private string variableName3 = "G_Char3_Affection";
    ...
    private void RefreshText()
    {
        ...
        // 一次性拼好字符串
        string v3 = GetVarString(variableName3);
        textMesh.text = $"Affection:{v3}";
    }
